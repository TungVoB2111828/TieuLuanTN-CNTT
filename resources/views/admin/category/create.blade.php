        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h1 class="card-title">Thêm Danh mục mới</h1>
                    <a href="{{ route('admin.category.index') }}" class="btn btn-secondary bg-primary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    counterElement.innerHTML = `<span id="charCount">0</span>/${maxLength} ký tự`;
